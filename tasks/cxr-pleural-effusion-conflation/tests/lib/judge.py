...
ACTION_LIBRARY_XLSX = ROOT.parent / "gold" / "pulmonary_action_library_with_2026_guideline_rewards.xlsx"

# Harbor packaging: OPENAI_API_KEY is injected as a real secret via
# [verifier.env] (see task.toml) - no local key file lookup here, unlike
# the original script's computer_use_eval/.openai_key convenience.
