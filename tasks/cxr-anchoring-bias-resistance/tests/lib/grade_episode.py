...
# Found in grader QA. a3 is 0 here specifically because this task's gold
# action list (ACT_STOP_SURVEILLANCE, ACT_OBSERVE) collapses to abstention-
# equivalent via _effective_gold_action_ids() above - 0 real action items
# to score, only the episode-level abstention_calibration/
# unnecessary_avoidance bounds apply.
_GOLD_ITEM_COUNTS = {"a1": 6, "a2": 2, "a3": 0}
